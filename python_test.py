...
program_languages=['bash','r','python','java','c++','ruby','perl','react','javascript','php']
...
start_url = "http://www.indeed.ca/jobs?q=software+engineer&l=Saskatoon%2C+SK"
...
for link in links:
    ...
    if get_info:
        ...
        print ('extracting %d job keywords...' % link)
